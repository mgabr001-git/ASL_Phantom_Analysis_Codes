...
unit_factor = 6000 ;   %%%  Flow unit conversion from mL/Vvol/sec into mL/100g/s  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  P=spm_select('ExtFPlist', roipath,'Full_Phantom_Mask_Pump400.nii');  % Pump rate ana 
...
%   title('3 mm Phantom, BS = 0','FontSize',16);
 ...
 hold off
   ...
   %%%  1 = Hemispherical ROI, 2 = Full Phantom, 3 = Jet ROI 
   if ROIflag == 1
