...
ROIflag = 1;  %%%  1 = Sphere Segment ROI, 2 = Full Phantom, 3 = Jet ROI 
...
%%%  Read in an original nii volume. 
  ...
  dataFolder = fullfile(roipath,'3DSp_ubpCASL_TR6s_LD1500_PLD100_BS0_PUMP200_ASL_0039/');
  firstfile = 's2019-08-18_12-11-124935-00001-00001-1.nii';
...
% pump rater changes. GeomMask updated to take into account displacements. 
...
%   title('3 mm Phantom, BS = 0','FontSize',16);
 ...
 hold off
   ...
   if ROIflag == 1
        fname=fullfile(codepath,strcat('par_maps/results/FitResults/2M0_Analysis/NoSmooth/OVERLAY_Hemisphere_Perf_vs_PLD_R',num2str(R),'Slice',num2str(slice),'OzMax',num2str(Oz_max)));
