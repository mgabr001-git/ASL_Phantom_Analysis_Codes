...
####   WEIGHTED ,   NO Smoothing  ########
#	 echo $PWD/results/VarWgtNoSmooth_2M0_PUMP${pump[iip]}_BS0/VarWgtNoSmooth_Perf_LD${ld}_PLD${pld[idx]}.nii  >>  NoWeight_perf_list_LD$ld.txt
...
####   NO Smoothing, No Weighting   ########
 ...
 ####   WEIGHTED ,   NO Smoothing  ########
 #    fslmerge -tr   $PWD/results/VarWgtNoSmooth_2M0_PUMP${pump[iip]}_BS0/MeanM0_Labeled_PLDseries_LD$ld.nii   `cat  meanM0_list_LD$ld.txt`    6
 #    fslmerge -tr   $PWD/results/VarWgtNoSmooth_2M0_PUMP${pump[iip]}_BS0/VarWgtNOSMOOTH_Perf_LD$ld.nii              `cat  NoWeight_perf_list_LD$ld.txt`  6
